      ...
      <div className="bg-accent py-16">
        <div className="grid px-5 sm:grid-cols-2 lg:grid-cols-4 gap-5 container mx-auto text-base-100">
            ...
            <div>
              <div>
                ...
                <p className="mb-5 text-neutral text-sm">
                  Mauris non nisi semper, lacinia neque in, dapibus leo. nec
                  tristique orci.Quisque vitae metus.
                </p>
              </div>
          ...
          <div>
            ...
            <ul className="mt-5">
              <li className="flex justify-start text-neutral gap-1 mb-2 text-sm hover:text-base-100">
          ...
          <div>
            <h2 className="text-2xl font-bold">Our Movies</h2>
            <ul className="mt-5">
              <li className="flex justify-start text-neutral gap-1 mb-2 text-sm hover:text-base-100">
                <i className="ri-add-line text-primary"></i>
          ...
          <div>
            ...
            <div className="flex justify-start items-center gap-3 mb-2 text-sm">
